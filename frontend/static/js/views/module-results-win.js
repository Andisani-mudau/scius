...
export default class extends AbstractView {
    constructor(params) {
        super(params);
        this.setTitle("SUBCON | Congratulations!");
    }
        ...
        return `
            ...
            <div class="fade">
                <div class="banner-content">
                    ...
                    <p>Woooh! hooow! let's do that again shall we?</p>  
                </div>
            </div>
        </div>
        <div class="dashboard-content module-win-container">
            <div class="module-win">
                <p class="title">Congratulations!</p>
                
                <p class="body">You made it! you was able to answer the correct answer at <b>03:05:32</b>, compared to one individual below you at <b>03:05:57</b>. Your payment is in progress, keep checking your emails. See you next time smartie!</p>
            </div>
